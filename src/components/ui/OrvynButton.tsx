...
export default function OrvynButton({
  ...
  const styles =
    variant === 'primary'
      ? 'bg-orvyn-performance text-orvyn-carbon hover:bg-white'
      : 'border border-orvyn-olive/50 text-orvyn-bone hover:border-orvyn-performance hover:text-white';
  ...
  const inner = (
    <>
      ...
      <span className="absolute inset-y-0 left-0 w-1/3 -translate-x-full bg-white/20 transition-transform duration-500 ease-out group-hover:translate-x-0" />
