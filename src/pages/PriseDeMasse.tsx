  ...
  return (
    <>
      ...
      <section className="relative bg-[#050505] pt-28 pb-16 lg:pt-36 lg:pb-20 overflow-hidden">
        <div className="absolute top-1/4 left-1/3 h-[450px] w-[450px] rounded-full bg-orange-500/5 blur-[120px] pointer-events-none" />
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          <span className="font-mono text-[10px] uppercase tracking-[0.25em] text-brand-green font-bold block mb-4">PRISE DE MASSE</span>
          <h1 className="font-display text-4xl font-extrabold text-white sm:text-6xl tracking-[-0.03em] mb-6">Repas prise de masse</h1>
          ...
          <div className="flex justify-center gap-6 mt-8">
            <div className="text-center">
              <p className="text-2xl font-extrabold text-brand-green font-mono">{massMeals.length}</p>
              <p className="text-[10px] font-mono uppercase text-neutral-500 tracking-wider">Repas adaptés</p>
            </div>
            <div className="text-center">
              <p className="text-2xl font-extrabold text-white font-mono">45-55g</p>
              <p className="text-[10px] font-mono uppercase text-neutral-500 tracking-wider">Protéines/repas</p>
            </div>
            <div className="text-center">
              <p className="text-2xl font-extrabold text-orange-400 font-mono">500-600</p>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
            <div className="space-y-6">
              <h2 className="font-display text-2xl font-extrabold text-white sm:text-3xl tracking-[-0.03em]">L'importance des protéines et de l'énergie</h2>
            ...
            <div className="bg-[#0a0a0a] border border-neutral-900 rounded-2xl p-6">
              <h3 className="text-sm font-bold text-white mb-4 flex items-center gap-2"><Dumbbell className="h-4 w-4 text-brand-green" /> Pour les athlètes en phase de volume</h3>
          ...
          <div className="text-center mb-12">
            <h2 className="font-display text-2xl font-extrabold text-white sm:text-4xl tracking-[-0.03em] mb-4">Nos repas pour la prise de masse</h2>
          </div>
      ...
      <section className="bg-[#050505] py-12 border-t border-neutral-900">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <Link to="/repas-post-entrainement" className="rounded-full bg-[#0a0a0a] border border-neutral-800 text-white px-6 py-3 text-[10px] font-mono tracking-wider uppercase font-bold hover:border-brand-green hover:text-brand-green transition">Repas post-entraînement</Link>
          </div>
        </div>
      </section>
      ...
      <section className="bg-[#050505] py-16 border-t border-neutral-900">
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="font-display text-2xl font-extrabold text-white sm:text-4xl tracking-[-0.03em]">Prise de masse : vos questions</h2>
          </div>
          <div className="space-y-3">
      ...
      <section className="bg-[#050505] py-16 border-t border-neutral-900">
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="font-display text-2xl font-extrabold text-white mb-4">Prêt à construire votre masse musculaire ?</h2>
